...
static void I2C_Mode_Config(void)
{
	...
	//I2C_InitStructure.I2C_DutyCycle = I2C_DutyCycle_2;      //I2C_DutyCycle用以设置I2C的占空比
	//I2C_InitStructure.I2C_OwnAddress1 = SlaveAddress;         //该参数用来设置第一个设备自身地址，它可以是一个7位地址或者一个10位地址
	I2C_InitStructure.I2C_Ack = I2C_Ack_Enable;       //I2C_Ack使能或者失能应答（ACK）
	I2C_InitStructure.I2C_AcknowledgedAddress = I2C_AcknowledgedAddress_7bit;   //I2C_AcknowledgedAddres定义了应答7位地址还是10位地址
	I2C_InitStructure.I2C_ClockSpeed = 50000;    //该参数用来设置时钟频率，这个值不能高于400KHz
...
while(!I2C_CheckEvent(I2C1,I2C_EVENT_MASTER_MODE_SELECT));   //检查最近一次I2C事件是否是输入的事件(EV5)

I2C_Send7bitAddress(I2C1,SlaveAddress,I2C_Direction_Transmitter);   //向指定的从I2C设备传送地址字

while(!I2C_CheckEvent(I2C1,I2C_EVENT_MASTER_TRANSMITTER_MODE_SELECTED));//(EV6)

I2C_SendData(I2C1,REG_Address);//通过外设I2Cx发送一个数据
...
I2C_AcknowledgeConfig(I2C1,DISABLE);    //失能应答
