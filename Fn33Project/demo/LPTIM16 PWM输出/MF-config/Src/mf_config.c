...
void MF_LPTIM16_TimerBase_Init(void)
{
    ...
    TimerBase_InitStruct.encoderMode = FL_LPTIM16_ENCODER_MODE_DISABLE;
...
void MF_LPTIM16_Channel1_Init(void)
{
    ...
    FL_LPTIM16_OC_InitTypeDef    LPTIM16_InitStruct;
    ...
    LPTIM16_InitStruct.compareValue = 499;
    LPTIM16_InitStruct.OCPolarity = FL_LPTIM16_OC_POLARITY_NORMAL;

    FL_LPTIM16_OC_Init(LPTIM16, FL_LPTIM16_CHANNEL_1, &LPTIM16_InitStruct);
}
