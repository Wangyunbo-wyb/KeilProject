...
void MF_LPTIM32_Channel1_Init(void)
{
    ...
    FL_LPTIM32_IC_InitTypeDef    LPTIM32_InitStruct;
    ...
    LPTIM32_InitStruct.ICSource = FL_LPTIM32_IC1_CAPTURE_SOURCE_GROUP0;
    LPTIM32_InitStruct.ICEdge = FL_LPTIM32_IC_EDGE_RISING;

    FL_LPTIM32_IC_Init(LPTIM32, FL_LPTIM32_CHANNEL_1, &LPTIM32_InitStruct);
}
...
void MF_LPTIM32_Interrupt_Init(void)
{
    ...
    FL_LPTIM32_EnableIT_CCOverflow(LPTIM32, FL_LPTIM32_CHANNEL_1);
