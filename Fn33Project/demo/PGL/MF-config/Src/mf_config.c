...
/**
  * @brief  LUT0 Initialization function
  * @param  void
  * @retval None
  */
void MF_LUT0_Init(void)
{
    FL_GPIO_InitTypeDef    GPIO_InitStruct;

    FL_PGL_LUT_InitTypeDef    PGL_InitStruct;
    ...
    PGL_InitStruct.input0  = FL_PGL_LUT_INPUT_GROUP0;
    PGL_InitStruct.input1  = FL_PGL_LUT_INPUT_GROUP0;
    PGL_InitStruct.input2  = FL_PGL_LUT_INPUT_DISABLE;
    PGL_InitStruct.input3  = FL_PGL_LUT_INPUT_DISABLE;
    PGL_InitStruct.edge    = FL_PGL_LUT_EDGE_RISING;
    PGL_InitStruct.outMode = FL_PGL_LUT_OUTPUT_COMBINE_LOGIC;

    (void)FL_PGL_LUT_Init(PGL, FL_PGL_LUT0, &PGL_InitStruct);
}
