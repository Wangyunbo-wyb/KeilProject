...
void MF_LPTIM16_Channel1_Init(void)
{
    ...
    LPTIM16_InitStruct.ICEdge = FL_LPTIM16_IC_EDGE_RISING;
...
void MF_LPTIM16_Interrupt_Init(void)
{
    ...
    FL_LPTIM16_EnableIT_CCOverflow(LPTIM16, FL_LPTIM16_CHANNEL_1);

    FL_LPTIM16_ClearFlag_CC(LPTIM16, FL_LPTIM16_CHANNEL_1);
    FL_LPTIM16_EnableIT_CC(LPTIM16, FL_LPTIM16_CHANNEL_1);
}
