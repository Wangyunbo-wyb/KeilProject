...
static void MF_ADC_Common_Init(void)
{
    ...
    Common_InitStruct.referenceSource = FL_ADC_REF_SOURCE_VREFP;                        /*配置ADC参考源*/
...
static void VREFP_Init(void)
{
    ...
    VREFP_InitStruct.voltageTrim = FL_VREFP_OUTPUT_VOLTAGE_3P0V_TRIM;                   /*电压trim值，对应outputVoltage输出的电压*/
    VREFP_InitStruct.outputVoltage = FL_VREFP_OUTPUT_VOLTAGE_3P0V;                      /*配置VREFP输出电压*/
