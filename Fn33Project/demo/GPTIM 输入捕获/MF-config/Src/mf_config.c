...
void MF_GPTIM0_TimerBase_Init(void)
{
    ...
    TimerBase_InitStruct.prescaler = 799;
    TimerBase_InitStruct.counterMode = FL_GPTIM_COUNTER_DIR_UP;
    TimerBase_InitStruct.autoReload = 0xFFFF;
...
void MF_GPTIM0_Channel1_Init(void)
{
    ...
    FL_GPTIM_IC_InitTypeDef    GPTIM0_InitStruct;
    ...
    GPTIM0_InitStruct.ICPolarity = FL_GPTIM_IC_POLARITY_NORMAL;
    GPTIM0_InitStruct.ICActiveInput = FL_GPTIM_CHANNEL_MODE_INPUT_NORMAL;
    GPTIM0_InitStruct.ICPrescaler = FL_GPTIM_IC_PSC_DIV1;
    GPTIM0_InitStruct.ICFilter = FL_GPTIM_IC_FILTER_DIV1;
    GPTIM0_InitStruct.captureState = FL_ENABLE;

    FL_GPTIM_IC_Init(GPTIM0, FL_GPTIM_CHANNEL_1, &GPTIM0_InitStruct);
}
